# DEMO: Use mocks to simulate SharePoint data

This completed project is the result of the lab exercise **Use mocks to simulate SharePoint data** that is referenced in the [README](../../README.md) in this repo.
